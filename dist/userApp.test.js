...
describe('UserApp', function () {
    ...
    describe('authUser', function () {
        ...
        it('return null when User not found', _asyncToGenerator(regeneratorRuntime.mark(function _callee5() {
        ...
        it('return null when User found but incorrect password', _asyncToGenerator(regeneratorRuntime.mark(function _callee6() {
            var password, user;
        ...
        it('return user when correct password', _asyncToGenerator(regeneratorRuntime.mark(function _callee7() {
            var password, user;
    ...
    describe('getAuthToken', function () {
        it('add errors when invalid userName or Email', _asyncToGenerator(regeneratorRuntime.mark(function _callee8() {
        ...
        it('add error when invalid password', _asyncToGenerator(regeneratorRuntime.mark(function _callee9() {
            var userRepository, userApp, authToken;
        ...
        it('generate token when correct password', _asyncToGenerator(regeneratorRuntime.mark(function _callee10() {
        ...
        it('add errors when incorrect password', _asyncToGenerator(regeneratorRuntime.mark(function _callee11() {
            var userRepository, userApp, authToken;
    ...
    describe('verifyAuthToken', function () {
        ...
        it('Invalid token throws exception', _asyncToGenerator(regeneratorRuntime.mark(function _callee12() {
            var hasError;
            ...
            }, _callee12, undefined, [[1, 6]]);
        })));
        it('Valid token return user', _asyncToGenerator(regeneratorRuntime.mark(function _callee13() {
